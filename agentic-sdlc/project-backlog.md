...
- [x] [Task 6: Notifications worker for due tasks](tasks/planned/task-6.md)
  ...
  - [x] [Task 6.3: Implement reminder worker job](tasks/planned/task-6-3.md)
  - [x] [Task 6.4: Implement idempotency and retry behavior](tasks/planned/task-6-4.md)
- [x] [Task 7: Audit trail implementation](tasks/planned/task-7.md)
  ...
  - [x] [Task 7.4: Integrate audit logging with tasks, attachments, and reminders](tasks/planned/task-7-4.md)
...
- [x] [Task 10: React frontend](tasks/planned/task-10.md)
  - [x] [Task 10.1: Confirm frontend requirements](tasks/planned/task-10-1.md)
  - [x] [Task 10.2: Set up React project and routing](tasks/planned/task-10-2.md)
  - [x] [Task 10.3: Implement auth-related frontend flows](tasks/planned/task-10-3.md)
